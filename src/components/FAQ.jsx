...
export const defaultFaqs = [
  {
    ...
    answer: "تختلف تكلفة صيانة مطبخ الألمنيوم في الكويت حسب نوع العطل والقطعة المطلوبة وحجم العمل. إصلاح المفصلات أو ضبط الأبواب يختلف عن تغيير سكك الأدراج أو تنفيذ عدة أعمال في الوقت نفسه. نحن في حرفي الكويت نقدم أسعاراً تنافسية ومدروسة تناسب جميع الميزانيات مع الحفاظ على أعلى معايير الجودة. يمكنك التواصل معنا للحصول على تقييم مجاني وعرض سعر دقيق بناءً على حالة مطبخك."
  },
  {
